...
<nav id="navbar">
  ...
  <a class="nav-logo" href="{{ url('/') }}" aria-label="Dapoer Pipin - Beranda">
    <div class="nav-logo-mark">
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M18.06 22.99h1.66c.84 0 1.53-.64 1.63-1.46L23 5.05h-5V1h-1.97v4.05h-4.97l.3 2.34c1.71.47 3.31 1.32 4.27 2.26 1.44 1.42 2.43 2.89 2.43 5.29v8.05zM1 21.99V21h15.03v.99c0 .55-.45 1-1.01 1H2.01c-.56 0-1.01-.45-1.01-1zm15.03-7c0-3.87-3.38-7-7.52-7-4.14 0-7.51 3.13-7.51 7h15.03zM3 11h8v2H3v-2z"/>
      </svg>
    </div>
  ...
  {{-- CTA + Burger --}}
  <div class="nav-right">
    <a href="https://wa.me/6281377573903?text=Halo%20Dapoer%20Pipin%2C%20saya%20ingin%20memesan"
